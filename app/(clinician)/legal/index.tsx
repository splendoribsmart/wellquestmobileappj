...
const LEGAL_DOCUMENTS: LegalDocument[] = [
  ...
  },
  {
    ...
    lastUpdated: 'January 8, 2025',
    route: '/(clinician)/legal/privacy',
    icon: 'lock',
  },
  {
    id: 'hipaa',
    title: 'HIPAA Compliance',
    description: 'Healthcare compliance and clinician obligations',
    lastUpdated: 'January 8, 2025',
    route: '/(clinician)/legal/hipaa',
    icon: 'shield',
  },
  {
    id: 'status',
...
export default function LegalIndexScreen() {
  ...
  return (
    <View
      testID="screen-clinician-legal-index"
          ...
          <Card>
            <View style={{ gap: theme.spacing[3] }}>
              ...
              <Text style={[styles.headerDescription, { color: colors.textSecondary }]}>
                ...
                how we protect patient health information in accordance with HIPAA regulations.
              </Text>
            </View>
          </Card>
          ...
          <Card>
            <View style={{ gap: theme.spacing[3] }}>
              ...
              <Text style={[styles.paragraph, { color: colors.textSecondary }]}>
                If you have questions about these legal documents or concerns about compliance,
                privacy, and data protection, please contact our legal team or visit the Support section.
              </Text>
