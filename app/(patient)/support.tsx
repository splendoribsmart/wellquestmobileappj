...
const INITIAL_MOCK_TICKETS: SupportTicket[] = [
  {
    id: '1',
    subject: 'Unable to view lab results',
    ...
    description: 'Lab results from last week are not showing up in my account',
  },
  {
    id: '2',
    ...
    description: 'Need clarification on charges from my last visit',
  },
  {
    id: '3',
    subject: 'Request for medication refill reminder feature',
    category: 'Feature Request',
    status: 'open',
    priority: 'low',
    createdAt: '2025-11-15T08:00:00Z',
    lastUpdated: '2025-11-15T08:00:00Z',
    description: 'Would be helpful to get reminders when medications need refilling',
  },
];
              ...
              <View style={styles.headerRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>
                    Get help with your account or share your feedback
                  </Text>
                </View>
